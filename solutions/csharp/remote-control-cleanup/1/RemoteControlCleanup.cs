public class RemoteControlCar
{
    ...
    public class CarTelemetry
    {
        ...
        public CarTelemetry(RemoteControlCar rc) => _rc = rc;
        public void Calibrate()
        {}
        
        public bool SelfTest() => true;
        
        public void ShowSponsor(string sponsorName) => _rc.SetSponsor(sponsorName);
        ...
        public void SetSpeed(decimal amount, string unitsString)
        {
            ...
            _rc.SetSpeed(new Speed(amount, speedUnits));
        }
    }
}
